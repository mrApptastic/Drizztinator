const backgrounds = [
  ...
  },
  {
    ...
    Languages: [],
    Proficiencies: ["Dragon's Game", "Thieves' Tools"],
    Abilities: [
      {
    ...
    Equipment: ['Crowbar', 'Set of Dark Common Clothes including a Hood'],
    Money: 15,
  },
  {
    Name: 'Folk Hero',
  ...
  },
  {
    ...
    Equipment: ['A set of Fine Clothes', 'Signet Ring', 'Scroll of Pedigree'],
    Money: 25,
  },
  {
    Name: 'Sage',
  ...
  },
  {
    ...
    Languages: ['Goblin', 'Kobold'],
    Proficiencies: ["Dragon's Game", 'Vehicles (Land)'],
    Abilities: [
      {
        Name: 'Military Rank',
        Description:
