...
export async function downloadCharacter(character) {
  ...
  /* Stats N' Stuff */
  const str = parseInt(
    character.Race.Modifiers.Strength + character.Stats.Strength
  );
  ...
  const dex = parseInt(
    character.Race.Modifiers.Dexterity + character.Stats.Dexterity
  );
  ...
  const con = parseInt(
    character.Race.Modifiers.Constitution + character.Stats.Constitution
  );
  ...
  const int = parseInt(
    character.Race.Modifiers.Intelligence + character.Stats.Intelligence
  );
  ...
  const wis = parseInt(
    character.Race.Modifiers.Wisdom + character.Stats.Wisdom
  );
  ...
  const cha = parseInt(
    character.Race.Modifiers.Charisma + character.Stats.Charisma
  );
  ...
  const personality =
    character.Background.Personality[
      Math.floor(Math.random() * character.Background.Personality.length)
    ];
  form.getTextField('PersonalityTraits ').setText(personality);
  form.getTextField('Ideals').setText(getIdeals(character));
  const bonds =
    character.Background.Bond[
      Math.floor(Math.random() * character.Background.Bond.length)
    ];
  form.getTextField('Bonds').setText(bonds);
  const flaws =
    character.Background.Flaw[
      Math.floor(Math.random() * character.Background.Flaw.length)
    ];
  form.getTextField('Flaws').setText(flaws);
  /* Proficiencies */
  const languages = character.Race.Languages.concat(
  ...
  /* Equipment */
  let gold =
    dice.roll(character.Class.Money.Type, character.Class.Money.Dice) *
      character.Class.Money.Factor +
    character.Background.Money;
  form.getTextField('GP').setText(gold.toString());
  const equipment = character.Class.Equipment.concat(
    character.Background.Equipment
  ).sort();
  form.getTextField('Equipment').setText(equipment.join(', ') + '.');
  /* Features and Traits */
  const traits = character.Race.Abilities.concat(
    character.Class.Abilities
  ).concat(character.Background.Abilities);
  let traitsText = '';
  ...
  if (equipment.includes('Greataxe')) {
    ...
    form
      .getTextField('Wpn1 Damage')
      .setText('1d12 ' + formatBonus(strBonus) + ' slashing');
  } else if (equipment.includes('Longsword')) {
    form.getTextField('Wpn Name').setText('Longsword');
    form.getTextField('Wpn1 AtkBonus').setText(formatBonus(strBonus + 2));
    form
      .getTextField('Wpn1 Damage')
      .setText('1d8 ' + formatBonus(strBonus) + ' slashing');
    ...
    form
      .getTextField('Wpn1 Damage')
      .setText('1d4 ' + formatBonus(finesse) + ' piercing');
  }
  if (equipment.includes('Longbow')) {
    ...
    form
      .getTextField('Wpn2 Damage ')
      .setText('1d8 ' + formatBonus(dexBonus) + ' slashing');
    form
      .getTextField('AttacksSpellcasting')
      .setText(
        '*You can shoot your longbow 150 feet, or up to 600 feet with disadvantage on the attack roll.'
      );
    ...
    form
      .getTextField('Wpn2 Damage ')
      .setText('1d8 ' + formatBonus(dexBonus) + ' piercing');
    form
      .getTextField('AttacksSpellcasting')
      .setText(
        '*You can shoot your light crossbow 80 feet, or up to 320 feet with disadvantage on the attack roll.'
      );
    ...
    form
      .getTextField('Wpn2 Damage ')
      .setText('1d6 ' + formatBonus(dexBonus) + ' piercing');
    form
      .getTextField('AttacksSpellcasting')
      .setText(
    ...
    form
      .getTextField('Wpn2 Damage ')
      .setText('1d6 ' + formatBonus(strBonus) + ' piercing');
    form
      .getTextField('AttacksSpellcasting')
      .setText(
    ...
    form
      .getTextField('AttacksSpellcasting')
      .setText(
        '*You can throw a dart 20 feet, or up to 60 feet with disadvantage on the attack roll.'
      );
  } else if (equipment.includes('Dagger') || equipment.includes('2 Daggers')) {
  ...
  if (equipment.includes('2 Handaxes')) {
    ...
    form
      .getTextField('Wpn3 Damage ')
      .setText('1d6 ' + formatBonus(strBonus) + ' slashing');
  } else if (
    !primaryIsDagger &&
    (equipment.includes('Dagger') || equipment.includes('2 Daggers'))
  ) {
    ...
    form
      .getTextField('Wpn3 Damage ')
      .setText('1d4 ' + formatBonus(finesse) + ' bludgeoning');
  }
  /* Saves */
  if (character.Class.Saves.Strength) {
    ...
    form
      ...
      .setText(formatBonus(strBonus + 2).toString());
  } else {
  ...
  if (character.Class.Saves.Dexterity) {
    ...
    form
      ...
      .setText(formatBonus(dexBonus + 2).toString());
  } else {
  ...
  if (character.Class.Saves.Constitution) {
    ...
    form
      ...
      .setText(formatBonus(conBonus + 2).toString());
  } else {
    form
      .getTextField('ST Constitution')
      .setText(formatBonus(conBonus).toString());
  }
  if (character.Class.Saves.Intelligence) {
    form.getCheckBox('Check Box 20').check();
    form
      .getTextField('ST Intelligence')
      .setText(formatBonus(intBonus + 2).toString());
  } else {
    form
      .getTextField('ST Intelligence')
      .setText(formatBonus(intBonus).toString());
  }
  if (character.Class.Saves.Wisdom) {
    form.getCheckBox('Check Box 21').check();
    form
      .getTextField('ST Wisdom')
      .setText(formatBonus(wisBonus + 2).toString());
  } else {
  ...
  if (character.Class.Saves.Charisma) {
    ...
    form
      ...
      .setText(formatBonus(chaBonus + 2).toString());
  } else {
  ...
  while (raceSkills > 0) {
    const random =
      character.Race.Skills.List[
        Math.floor(Math.random() * character.Race.Skills.List.length)
      ];
  ...
  while (classSkills > 0) {
    const random =
      character.Class.Skills.List[
        Math.floor(Math.random() * character.Class.Skills.List.length)
      ];
    if (!skills.includes(random)) {
      skills.push(random);
      classSkills--;
  ...
  if (skills.includes('Acrobatics')) {
    ...
    form
      ...
      .setText(formatBonus(dexBonus + bonus).toString());
  } else {
  ...
  if (skills.includes('Animal Handling')) {
    ...
    form
      .getTextField('Animal')
      .setText(formatBonus(wisBonus + bonus).toString());
  } else {
  ...
  if (skills.includes('Arcana')) {
    ...
    form
      .getTextField('Arcana')
      .setText(formatBonus(intBonus + bonus).toString());
  } else {
  ...
  if (skills.includes('Athletics')) {
    ...
    form
      ...
      .setText(formatBonus(strBonus + bonus).toString());
  } else {
  ...
  if (skills.includes('Deception')) {
    ...
    form
      ...
      .setText(formatBonus(chaBonus + bonus).toString());
  } else {
  ...
  if (skills.includes('Sleight of Hand')) {
    ...
    form
      .getTextField('SleightofHand')
      .setText(formatBonus(dexBonus).toString());
  }
  ...
  const age = Math.round(
    character.Race.Appearance.Age * (1 + dice.roll(100) / 100)
  );
  form.getTextField('Age').setText(age.toString());
  const inches = Math.round(
    character.Race.Appearance.Height * 0.9 + dice.roll(20) / 100
  );
  ...
  const weight = Math.round(
    character.Race.Appearance.Weight * 0.8 + dice.roll(40) / 100
  );
  form.getTextField('Weight').setText(weight.toString() + ' lbs.');
  const eyes =
    character.Race.Appearance.Eyes[
      Math.floor(Math.random() * character.Race.Appearance.Eyes.length)
    ];
  form.getTextField('Eyes').setText(eyes);
  const skin =
    character.Race.Appearance.Skin[
      Math.floor(Math.random() * character.Race.Appearance.Skin.length)
    ];
  form.getTextField('Skin').setText(skin);
  const hair =
    character.Race.Appearance.Hair[
      Math.floor(Math.random() * character.Race.Appearance.Hair.length)
    ];
  ...
  if (character.Race.Spells.Cantrips.Count > 0) {
    while (cantrips.length !== character.Race.Spells.Cantrips.Count) {
      const random =
        character.Race.Spells.Cantrips.List[
          Math.floor(Math.random() * character.Race.Spells.Cantrips.List.length)
        ];
  ...
  if (character.Class.Spells.Cantrips.Count > 0) {
    while (
      cantrips.length !==
      character.Race.Spells.Cantrips.Count +
        character.Class.Spells.Cantrips.Count
    ) {
      const random =
        character.Class.Spells.Cantrips.List[
          Math.floor(
            Math.random() * character.Class.Spells.Cantrips.List.length
          )
        ];
      if (!cantrips.includes(random)) {
        cantrips.push(random);
  ...
  if (character.Race.Spells.Lvl1.Count > 0) {
    while (firstLevel.length !== character.Race.Spells.Lvl1.Count) {
      const random =
        character.Race.Spells.Lvl1.List[
          Math.floor(Math.random() * character.Race.Spells.Lvl1.List.length)
        ];
  ...
  if (character.Class.Spells.Lvl1.Count > 0) {
    while (
      firstLevel.length !==
      character.Race.Spells.Lvl1.Count + character.Class.Spells.Lvl1.Count
    ) {
      const random =
        character.Class.Spells.Lvl1.List[
          Math.floor(Math.random() * character.Class.Spells.Lvl1.List.length)
        ];
      if (!firstLevel.includes(random)) {
        firstLevel.push(random);
      }
  ...
  while (!chosenOne) {
    const random =
      character.Background.Ideal[
        Math.floor(Math.random() * character.Background.Ideal.length)
      ];
