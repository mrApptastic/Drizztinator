const classes = [
  ...
  },
  {
    ...
    Proficiencies: ['Simple Weapons', 'Shortswords', 'Flute'],
    Skills: {
      Count: 2,
      List: [
        'Acrobatics',
    ...
    Equipment: ['Shortsword', '10 Darts', "Explorer's pack"],
    Money: {
      Dice: 5,
      Type: 4,
      Factor: 1,
  ...
  },
  {
    ...
    Equipment: ['Quarterstaff', "Explorer's pack", 'Arcane Focus', 'Spellbook'],
    Money: {
      Dice: 4,
      Type: 4,
      Factor: 10,
